...
export default function ChargeScene(props: SceneProps) {
  ...
  return (
    <group ref={root}>
      <Particles kind="dot" count={260} color="#dfffd0" area={[16, 10, 10]} size={[0.01, 0.035]} lift={0.02} sway={0.05} seed={21} />
      <group ref={rings}>
        <SegmentedRings color="#6fe08a" core={false} visible={() => range(p(), 0.12, 0.45)} />
      </group>
    </group>
  );
}
